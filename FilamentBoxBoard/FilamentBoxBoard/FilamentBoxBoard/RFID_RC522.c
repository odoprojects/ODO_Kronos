...
#define NULL ( (void *) 0)
// void initMFRC522(MFRC522 *mfr,uint8_t chipSelectPin,		///< Arduino pin connected to MFRC522's SPI slave select input (Pin 24, NSS, active low)
...
void PCD_Init() {
	ENABLE_CHIP();
	DISABLE_CHIP();
	SPI_CS_0_DDR |=(1<<SPI_CS_0_RESET);
	SPI_CS_0_PORT |=(1<<SPI_CS_0_RESET);
